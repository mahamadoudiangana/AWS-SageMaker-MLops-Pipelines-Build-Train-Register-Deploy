...
def output_fn(prediction, content_type):
    import json
    if content_type == 'text/csv': # In our case, we want the response from the model to be a list of numbers with the length of the incoming request data points length (text/csv) and not a 'application/json':
